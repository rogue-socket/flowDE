...
/**
 * Raw payload generated by the embedded Python tracing runtime.
 */
...
/**
 * Normalized execution event forwarded to the webview runtime timeline.
 */
...
/**
 * Source slice boundaries for a Python function definition block.
 */
...
/**
 * Owns a single FlowDE webview panel and bridges graph/runtime operations.
 */
class FlowDEPanel implements vscode.Disposable {
  ...
  /**
   * Cleans up panel resources and active runtime tracing processes.
   */
  public dispose(): void {
  ...
  /**
   * Recomputes function/module lookup maps used by execution-event reconciliation.
   */
  ...
  /**
   * Starts a Python trace subprocess and streams runtime events to the webview.
   */
  ...
  /**
   * Stops the active runtime trace and optionally suppresses completion reporting.
   */
  ...
  /**
   * Resolves the Python file to run for runtime tracing.
   */
  ...
  /**
   * Writes the embedded Python tracer script to a temporary file.
   */
  ...
  /**
   * Spawns a Python process for runtime tracing with command fallback.
   */
  ...
  /**
   * Spawns a child process and resolves once the process successfully starts.
   */
  ...
  /**
   * Buffers and splits trace process output into line-oriented payloads.
   */
  ...
  /**
   * Parses a single JSON trace payload and forwards mapped events to the webview.
   */
  ...
  /**
   * Sends a runtime completion summary to the webview.
   */
  ...
  /**
   * Maps raw runtime payloads into normalized execution events.
   */
  ...
  /**
   * Resolves the most likely graph node for a runtime event.
   */
  ...
  /**
   * Attempts to extract class context from Python qualname segments.
   */
  ...
  /**
   * Checks whether a function node belongs to a class with the provided name.
   */
  ...
  /**
   * Picks the candidate node closest to the runtime line number.
   */
  ...
  /**
   * Creates a deterministic lookup key for function scope maps.
   */
  ...
  /**
   * Converts an absolute path into a workspace-relative, slash-normalized path.
   */
  ...
  /**
   * Appends a function stub to a selected module from graph edit controls.
   */
  ...
  /**
   * Inserts a generated function call from source node to target node.
   */
  ...
  /**
   * Renames a graph node symbol across workspace Python files.
   */
  ...
  /**
   * Moves a top-level function definition to another module.
   */
  ...
  /**
   * Posts graph-edit operation results back to the webview.
   */
  ...
  /**
   * Reads a UTF-8 file under the active workspace.
   */
  ...
  /**
   * Writes a UTF-8 file under the active workspace.
   */
  ...
  /**
   * Validates whether a string is a legal Python identifier and not a keyword.
   */
  ...
  /**
   * Locates a function definition block boundaries in source text.
   */
